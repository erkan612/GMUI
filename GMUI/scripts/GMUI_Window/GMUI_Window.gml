...
function gmui_begin_window(name, x = -1, y = -1, width = -1, height = -1, flags = 0) {
	...
	var nested_width = ww - window_border_width * 2;
	var nested_height = wh - (has_title ? style.window_title_height + window_border_width : window_border_width * 2);
	if (window._win_collapsed || !gmui_begin_container(name + "_content_container", undefined, undefined, nested_width, nested_height)) { gmui_end_container_plain(); return false; };
